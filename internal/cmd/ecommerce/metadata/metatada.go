...
// Attention(hemiun): This package copied from fedbox.metadata for resolving "import cycle not allowed" error
...
func AddKeyToPerson(metaSaver common.MetadataTyper, typ string) func(act *vocab.Actor) error {
